...
import { react, git, express, css, html, js, mongo, mui, node, country, crypto, ricky, shop, translate, resort } from "./assets/index";
  ...
  return (
    <ThemeProvider theme={dark_theme}>
      ...
      <Container sx={{
        ...
        <Dialog open={showPdf}
          fullScreen>
          <Button variant="contained" color="primary" size="small" onClick={() => setShowPdf(false)} onClose={() => setShowPdf(false)}>
            close Pdf
          </Button>
          <DialogContent sx={{
            display: 'block',
            ...
            <object type="application/pdf" data={pdffile} width={Mobile ? '100%' : "800px"} height="100%"></object>
          </DialogContent>
        </Dialog>
        <Stack direction={{ xs: 'column-reverse', lg: 'row' }} justifyContent="center" alignItems="center" spacing={1}>
          ...
          >
            ...
            <Stack direction="row" justifyContent="start" alignItems="center" sx={{
              ...
              <Box>
                <IconButton color="info" size="small" component="a" href="https://www.linkedin.com/in/lakshman-saladi/">
                  <LinkedInIcon />
                </IconButton>
                <IconButton color="warning" size="small" component="a" onClick={() => window.open('https://www.instagram.com/lakshman_saladi?igsh=dDY0cGMyMGNid2Pr')}>
                  <InstagramIcon />
                </IconButton>
              </Box>
            </Stack>
      ...
      <Box sx={{
        ...
        <VerticalTimeline>
          <VerticalTimelineElement
            ...
            contentStyle={{ background: 'rgb(33, 150, 243)', color: 'inherit', fontFamily: 'helvetica' }}
          ...
          >
            <h3 className="vertical-timeline-element-title"
              ...
              Analyst III Infrastructure services</h3>
            <h4 className="vertical-timeline-element-subtitle"
              style={{ color: 'white', fontFamily: 'roboto' }}
            >DXC Technology</h4>
            <p>
              Incident Management, SQL, PowerBi, Shell Scripting, Excel
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          >
            <h3 className="vertical-timeline-element-title"
              style={{ fontFamily: 'roboto', color: 'black' }}>BVRAJU Degree College</h3>
            <h4 className="vertical-timeline-element-subtitle"
              style={{ fontFamily: 'roboto', color: 'black' }}>Bhimavaram, Andra Pradesh</h4>
      ...
      <Container>
        <Box sx={{
          ...
          >Tools and Technologies</Typography>
          <Divider />
          <Container sx={{
            display: 'flex',
            ...
            <Grid container spacing={1.2}
              sx={{
                palceItems: 'center', width: { lg: 800, sm: 440, xs: 490 }, marginBlockStart: 3, marginBlockEnd: 5
              }}>

              {Array.from(Images, (image, index) => {
                return <Grid item xs={4} sm={4} lg={2} spacing={1} key={index} component={motion.div}
                  initial={{
                    opacity: 0,
                ...
                >
                  ...
                  >
                    <Box component="img" src={image} alt="" sx={{
                      width: '100%',
                      height: '100%',
                      objectFit: 'fill'
                    }} />
        ...
        <Box sx={{ paddingBlockStart: { xs: 8, lg: 12 } }}>
          <Container>
            ...
            >Projects I built</Typography>
            <Divider />
          </Container>
          <Grid container spacing={1.2} sx={{ paddingBlockStart: 4, paddingBlockEnd: 7 }}>

            {Projects.map((project, index) => {
              const { demo, image, code, desc } = project;
              return <Grid item key={index} xs={12} sm={6} lg={4} component={motion.div}
                initial={{
                  opacity: 0,
              ...
              >
                <Card sx={{
                  ...
                  <CardActions>
                    <Button variant="contained" component="a" href={demo} size="small" sx={{
                      bgcolor: '#c27094',
                      "&:hover,&:focus": {
                        bgcolor: '#c27094',
                      }
                    ...
                    <Button variant="outlined" color="inherit" component="a" href={code} size="small">
                      get code
                    </Button>
                  </CardActions>
                </Card>
      ...
      <Box sx={{
        ...
        <Typography color="inherit" textAlign="center" sx={{
          display: 'block',
          margin: 'auto',
          p: 2,
          fontSize: { xs: 14, sm: 17, lg: 18 }
        }}>
          If my profile meet your requirements, you can email me or call {callComponent}
        </Typography>
